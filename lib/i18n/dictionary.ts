...
export const dict: Record<Lang, Dict> = {
  pt: {
    ...
    intro: {
      title: "Uma viagem aos aromas do Magrebe e ao autêntico brunch em Lisboa",
      body: "No Azul Caffé & Brunch's Dz honramos as receitas ancestrais da Argélia. Dos grãos de sémola rolados à mão ao msemen folhado e tajines aromáticos, cada prato é uma expressão viva de hospitalidade, calor e partilha.",
      ...
      b3d: "Serviço caloroso, chá de menta servido do alto e um ambiente acolhedor e intimista.",
    },
    signature: {
    ...
    gallery: {
      tag: "O Ambiente",
      title: "A Alma do Azul Caffé & Brunch's Dz",
    ...
    about: {
      ...
      title: "Azul Caffé: Onde o Brunch Encontra a Alma Argelina",
      p1: "O Azul Caffé & Brunch's Dz nasceu do amor pela rica gastronomia da Argélia e do desejo de partilhar essa herança vibrante com Lisboa. No coração do Bairro Alto, criámos um refúgio onde o calor da hospitalidade argelina, o aroma do café e as especiarias do Magrebe se fundem com a luz atlântica.",
    ...
    visit: {
      tag: "Onde Estamos",
      title: "Visite o Azul Caffé & Brunch's Dz no Bairro Alto",
      address: "Endereço",
      ...
      parking: "Parques Próximos",
      parkingValue: "Parque Praça Luís de Camões & Parque Calçada do Combro (a 3 min a pé).",
      transit: "Transportes",
    ...
    reserveCta: {
      title: "Garanta a Sua Mesa no Azul Caffé & Brunch's Dz",
    ...
    reserveForm: {
      ...
      successBody: "A sua mesa foi reservada com sucesso no Azul Caffé & Brunch's Dz. Enviámos a confirmação com todos os detalhes.",
    ...
    footer: {
      tagline: "Autêntico Brunch & Cozinha Argelina no Bairro Alto, Lisboa. Couscous, Tajines, Msemen e Hospitalidade.",
      explore: "Explorar",
      contact: "Contactos",
      hours: "Horários",
  ...
  en: {
    ...
    intro: {
      title: "A journey through the rich aromas of the Maghreb & authentic brunch in Lisbon",
      body: "At Azul Caffé & Brunch's Dz we honor Algeria's ancestral culinary traditions. From fine hand-steamed semolina to flaky msemen, savory tagines, and fragrant mint tea, every dish is an invitation to warmth and sharing.",
      ...
      b3d: "Heartfelt hospitality, spearmint tea poured high in silver pots, and an intimate, welcoming dining room.",
    },
    signature: {
    ...
    gallery: {
      tag: "Atmosphere",
      title: "Inside Azul Caffé & Brunch's Dz",
    ...
    about: {
      tag: "Our Heritage",
      title: "Azul Caffé: Where Brunch Meets Algerian Soul",
      p1: "Azul Caffé & Brunch's Dz was founded with a single passion: to bring the authentic, generous flavors of Algerian brunch and traditional cuisine to Lisbon. Nestled in iconic Bairro Alto, our café provides an escape where warm terracotta tones, fragrant spices, and Mediterranean zellige motifs embrace the gentle Atlantic breeze.",
    ...
    visit: {
      tag: "Find Us",
      title: "Visit Azul Caffé & Brunch's Dz in Bairro Alto",
      address: "Address",
    ...
    reserveCta: {
      title: "Reserve Your Table at Azul Caffé & Brunch's Dz",
    ...
    reserveForm: {
      ...
      successBody: "Your table is locked in at Azul Caffé & Brunch's Dz. We have dispatched a confirmation with all your details.",
  ...
  fr: {
    ...
    intro: {
      title: "Un voyage au cœur des saveurs du Maghreb et du brunch à Lisbonne",
      body: "Chez Azul Caffé & Brunch's Dz, nous célébrons les recettes d'antan de nos mères et grands-mères. De la semoule roulée à la main au msemen croustillant, tajines parfumés et thé à la menthe, chaque assiette est un geste de générosité.",
      ...
      b3d: "Accueil chaleureux, thé à la menthe versé de haut en théière argentée et ambiance feutrée.",
    },
    signature: {
    ...
    gallery: {
      tag: "L'Ambiance",
      title: "L'Âme de Azul Caffé & Brunch's Dz",
    ...
    about: {
      tag: "Notre Héritage",
      title: "Azul Caffé : Le Brunch et la Haute Gastronomie Algérienne",
      p1: "Azul Caffé & Brunch's Dz est né d'une passion ardente pour la haute gastronomie et le brunch algérien, et de l'envie de la partager avec Lisbonne. Dans les ruelles du Bairro Alto, nous avons créé un sanctuaire où la convivialité algérienne, les épices douces et le café dialoguent avec la douceur portugaise.",
    ...
    reserveCta: {
      title: "Réservez Votre Table Chez Azul Caffé & Brunch's Dz",
    ...
    reserveForm: {
      ...
      successBody: "Votre table est prête chez Azul Caffé & Brunch's Dz. Nous vous avons transmis le récapitulatif par message.",
    ...
    footer: {
      tagline: "Brunch et cuisine algérienne authentique au Bairro Alto, Lisbonne. Couscous, tajines, msemen et hospitalité.",
      explore: "Explorer",
      contact: "Contact",
      hours: "Horaires",
  ...
  ar: {
    ...
    intro: {
      title: "رحلة أصيلة في عبق المطبخ والبرانش الجزائري العريق",
      body: "في أزول كافيه & برانش دزاد نحيي أسرار الطبخ والبرانش الجزائري الموروث. من حبات السميد المفتولة باليد والمسمن المورق إلى الطواجن الفخارية المعطرة، كل طبق هو عنوان للكرم والدفء والضيافة.",
    ...
    gallery: {
      tag: "الأجواء",
      title: "في رحاب أزول كافيه & برانش دزاد",
    ...
    about: {
      tag: "حكايتنا",
      title: "أزول كافيه: حيث يلتقي البرانش بأصالة الجزائر",
      p1: "انطلقت فكرة أزول كافيه & برانش دزاد من العشق العميق لأصالة المائدة الجزائرية والرغبة في تقديم أرقى تجربة برانش ومأكولات تقليدية في لشبونة. في أزقة بايرو ألتو التاريخية، أبدعنا فضاءً يجمع بين دفء الضيافة الجزائرية والتوابل العطرة والنكهات الأصيلة.",
      p2: "نلتزم بالحفاظ على أسرار الوصفات الأصلية: الزعفران، الكمون البلدي، رأس الحانوت الفاخر، الليمون المصبر وماء الزهر الصافي. في أزول كافيه، كل ضيف يدخل كفرد من العائلة.",
      stat1: "100%",
      stat1l: "حلال معتمد",
      stat2: "16+",
    ...
    reserveCta: {
      title: "احجز طاولتك الآن في أزول كافيه & برانش دزاد",
    ...
    reserveForm: {
      ...
      successBody: "طاولتك محجوزة في أزول كافيه & برانش دزاد. أرسلنا لك كافة تفاصيل الحجز ونتشوق لاستقبالكم.",
    ...
    footer: {
      tagline: "أصالة البرانش والمطبخ الجزائري في بايرو ألتو، لشبونة. كسكسي، طواجن، مسمن وضيافة راقية.",
      explore: "استكشف",
      contact: "اتصل بنا",
      hours: "أوقات العمل",
